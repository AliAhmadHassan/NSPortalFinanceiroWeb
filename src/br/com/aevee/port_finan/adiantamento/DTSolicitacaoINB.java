...
/**
 * <p>Classe Java de DT_Solicitacao_INB complex type.
 * 
 * <p>O seguinte fragmento do esquema especifica o conteúdo esperado contido dentro desta classe.
 * 
 * <pre>
 * &lt;complexType name="DT_Solicitacao_INB">
 *   &lt;complexContent>
...
@XmlType(name = "DT_Solicitacao_INB", propOrder = {
    "header",
    "input"
})
public class DTSolicitacaoINB {

    @XmlElement(name = "Header", required = true)
    protected DTHeader header;
    @XmlElement(name = "Input")
    protected List<DTSolicitacaoINB.Input> input;
     ...
     * {@link DTSolicitacaoINB.Input }
     * 
     * 
     */
    public List<DTSolicitacaoINB.Input> getInput() {
        if (input == null) {
            input = new ArrayList<DTSolicitacaoINB.Input>();
        }
        return this.input;
    }
